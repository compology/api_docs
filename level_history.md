...
| was_emptied             | boolean | If present, indicates whether the container was emptied prior to this event. This value may update for recent events as Compology has more time to classify data but should be relatively static 12 hours after the occurred_at timestamp. | t |
